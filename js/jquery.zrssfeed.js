...
(function($){
	...
	var _process = function(e, data, options) {
		...
		for (var i=options.offset; i<feeds.entries.length; i++) {
			...
			rowArray[rowIndex]['html'] = '<'+ options.titletag +'><a href="'+ options.linkredirect + feedLink +'" title="View this feed at '+ feeds.title +'">' + '<hr>' + entry.title + '<hr>' +'</a></'+ options.titletag +'>'

			//if (options.date && pubDate) rowArray[rowIndex]['html'] += '<div>'+ pubDate +'</div>'
             if (options.date && pubDate) rowArray[rowIndex]['html'] += '<div>' + pubDate + ' ago' +'</div>'
